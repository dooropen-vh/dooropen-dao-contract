...
import "../interfaces/ILockDOCProxy.sol";
...
/// @title The proxy of DOC Plaform
    ...
    ILockDOCProxy
{
    ...
    constructor(address _impl, address _admin) {
        ...
        require(_impl != address(0), "LockDOCProxy: logic is zero");
    ...
    function upgradeTo(address impl) external override onlyOwner {
        require(impl != address(0), "LockDOCProxy: input is zero");
        require(_implementation() != impl, "LockDOCProxy: same");
    ...
    function _fallback() internal {
        ...
        require(
            ...
            "LockDOCProxy: impl OR proxy is false"
        );
    ...
    function initialize(
        ...
        require(doc == address(0), "Already initialized");
        doc = _doc;
